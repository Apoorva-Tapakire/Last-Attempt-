...
namespace ProjectWebApplication.Controllers
{
    ...
    public class CustomerController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult CartInsert(CartModel cart)
        {
            CustomerDAL ds = new CustomerDAL();
        ...
        [HttpPut]
        public IHttpActionResult CartUpdate(CartModel cart)
        {
            CustomerDAL ds = new CustomerDAL();
            CartBAL bal = new CartBAL();
        ...
        public IHttpActionResult CartDelete(CartModel cart)
        {
            CustomerDAL ds = new CustomerDAL();
            CartBAL bal = new CartBAL();
            bal.ProductId = cart.ProductId;
